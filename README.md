...
- **Optional**:
    ...
    - `consequence` (str): Regex pattern to filter variants for their consequences. Options = ['stop_gained', 'frameshift_variant', 'stop_lost', 'missense_variant', 'splice_region_variant', 'splice_donor_variant', 'splice_acceptor_variant'] Default = 'missense_variant|frameshift_variant|stop_gained".
